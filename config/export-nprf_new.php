 ...
 if ($page=="nprf"|| $page=="privew-nprf"){
  ...
  <thead><tr><td>
	...
	<table  border="1" cellpadding="0" cellspacing="0" width="110%">
		<tr >
		  <td width="15%" rowspan="4"><img src="../img/Logo.png"  width="140px" height="80"></td>
		  <td width="55%" rowspan="4" align="center" valign="middle" ><h3>NEW PRODUCT REVIEW FORM</h3></td>
		  <td width="40%" align="left">NO : <?php  echo $NoIso; ?></td>
	  	</tr>
		<tr>
    ...
    <div class="content">
		...
		<tr>
		  <td colspan="3"><table cellpadding="0" cellspacing="0" border="0" >
            <tr style='font-size:12px;'>
              <td colspan="7" ><table border="0" width="100%" >
                <tr>
                  <td width="55%" align="left"><table cellpadding="0" cellspacing="0" border="1" width="100%" >
                      <tr style='font-size:14px;'>
                  ...
                  <td width="54%" height="24" valign="top" align="right">
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%">
		  	<tr style='font-size:12px;'>
              <td width="200" background="../img/bg.jpg" style="text-align:right;height:20px;padding:0px 2px 0px 0px;"  >
			  Theme No, / Item No. </td>
...
5) Renewal of existing Products to improve quality</label >
			...
			<tr style='font-size:14px;'>
              ...
              <td colspan="6" style="max-width:60%; text-align:left;padding:3px 0px 3px 3px;">
  ...
  <tfoot><tr><td>
    <div class="footer-space">dsfds</div>
  </td></tr></tfoot>
</table>
<style>
.header, .header-space,

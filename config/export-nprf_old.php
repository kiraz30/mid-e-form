...
if ($page=="nprf"|| $page=="privew-nprf"){
		include "connect.php";
      	$exe =mysqli_query($con,"SELECT ID_No,Request_No,Thema_Number,Thema_Name,Type_Request,Purpose_1,Purpose_2,Purpose_3,
		...
		date_format(Launching_Date,'%M-%Y') as Launching_Date,Market_Situasion,T_Consumer_M,T_Consumer_F,
		T_Age_GroupStart,T_Age_GroupEnd,T_Sosial_Economic_Class,Status_NPRF,
		...
		if($tampildata['Type_Request']=="Domestic")	{
			$NoIso="FR/MKTPD1/GPD1-001";
			$tglIso="08/01/2018";}
		elseif($tampildata['Type_Request']=="Export"){
			$NoIso="FR/MKTPD1/GPD1-001";
			$tglIso="08/01/2018";}
		else{
			$NoIso="";
...
<body <?php if ($page=="privew-nprf" && $tampildata['Status_NPRF']!='Complete By MID'){ echo 'background="../img/watermark.png"';}?>>
<?php
if ($page=="nprf"){?>
<script>
window.print();
...
<?php } 
	if ($page=="privew-nprf" && $tampildata['Status_NPRF']!='Complete By MID'){ echo '<h1>Preview Report</h1>';}?> 
	<table  class="demo-table responsive" border="1" width="900" align="center" style=' padding:0px 0px 0px 0px;'>
		<tr>
		  <td rowspan="4" style="width:195px;"><img src="../img/Logo.png"  width="140px" height="80"></td>
		  <td rowspan="4"   align="center" valign="middle" style="width:900px;"><h2>NEW PRODUCT REVIEW FORM <?php echo strtoupper($typeReq); ?></h2></td>
		...
		<tr style='font-size:14px;'>
		  <td colspan="3">Sent to : <br>
	      Addressed to : <br> </td>
		  </tr>
		<tr>
		  <td colspan="3"><table cellpadding="0" cellspacing="0" border="1" width="100%" >
			
            <tr style='font-size:12px;'>
              <td colspan="7" ><table border="0" width="100%" >
                <tr>
                  <td width="250" align="left"><table cellpadding="0" cellspacing="0" border="1" width="100%" >
                      <tr style='font-size:14px;'>
                        <td colspan="3" bgcolor="#CCCCCC" align="center"><strong>PT.
                            Mandom Indonesia Tbk</strong></td>
                      </tr>
                      <tr style='font-size:12px;'>
                        <td style="text-align:center; width:120px; height:20px;" >Prepared
                          by</td>
                        <td style="text-align:center;height:20px; ">Approved
                          By</td>
                        <td style="text-align:center;height:20px; ">Approved
                          by</td>
                      </tr>
                      <tr style='font-size:14px;'>
                        <td align="center" style="height:20px;">PIC/CH/SH</td>
                        <td align="center">MG/GM/EO</td>
                        <td align="center">Prodev Director</td>
                      </tr>
                      <tr style='font-size:11px;'>
                        <td style="text-align:center; width:20px; height:80px;">
						<?php ShowTtdNamaTglByPosisi($tampildata['Request_No'],"NPRF","'01','02','03'");?>
						</td>
                        <td align="center">
						<?php ShowTtdNamaTglByPosisi($tampildata['Request_No'],"NPRF","'04','51721','52907'");?>
						</td>
                        <td align="center">
						<?php ShowTtdNamaTglByPosisi($tampildata['Request_No'],"NPRF",'46599');?>
						</td>
                  ...
                  <td width="50" style='font-size:10px;' valign="bottom" >When
                    issue NPRF, have to Attach MOM(NPM & NSM)</td>
                  <td width="20" style='font-size:8px;' valign="top" ><img src="../img/next.png" height="100px" width="20px" align="right"></td>
                  <td width="300" height="24" valign="top" align="right"><table cellpadding="0" cellspacing="0" border="1" width="100%" >
                      <tr style='font-size:14px;'>
                        <td colspan="4" bgcolor="#CCCCCC" align="center"><strong>For
                            use of MCJ Product Depelovment Department Only</strong></td>
                      </tr>
                      <tr style='font-size:14px;'>
                        <td rowspan="3" ><input type="radio" disabled="disabled">
                          Registered<br>
                        ...
                        <td style="text-align:center; width:90px; height:20px;">Prepared
                          by</td>
                        <td style="text-align:center;">Reviewer by</td>
            ...
            <tr style='font-size:14px;'>
              <td width="18%" background="../img/bg.jpg" style="text-align:right;height:20px;padding:0px 2px 0px 0px;"  >
			  <img src="../img/bg.jpg"  width="170px" height="10">Theme No,/Item No. </td>
              <td width="82%" colspan="6" style="text-align:left;margin-left:3px; padding:2px 2px 2px 2px;"><?php echo $tampildata['Thema_Number']; ?> </td>
            </tr>
			<tr style='font-size:14px;'>
...
5) Renewal of existing Products to improve quality</label >
            ...
            <tr style='font-size:14px;'>
			  ...
			  <?php echo $tampildata["Launching_Date"]; ?> 
			  </td>
            </tr>
            <tr style='font-size:14px;'>
              <td style="text-align:right; height:20px; padding:0px 2px 0px 0px;">Market Situation / Background of request</td>
              <td colspan="6" style="max-width:67%; text-align:right;padding:3px 0px 3px 3px;">
			  
			  <div class="c"><?php  echo $tampildata["Market_Situasion"]; ?></div>
			   </td>
            </tr>
            <tr style='font-size:14px;'>
              <td style="text-align:right; height:20px; padding:0px 2px 0px 0px;">Target </td>
              <td width="150" style="text-align:left;padding:0px 0px 3px 3px;">Consumer</td>
              <td width="200" style="text-align:left;padding:0px 0px 3px 3px;"><?php if ($tampildata['T_Consumer_M']==1) { echo 'Male';} 
			  elseif ($tampildata['T_Consumer_F']==1) { echo 'Female';} ?></td>
			  <td width="150" style="text-align:left;padding:0px 0px 3px 3px;">Age Group</td>
			  <td width="200" style="text-align:left;padding:0px 0px 3px 3px;"><?php echo $tampildata['T_Age_GroupStart']; 
			  if ($tampildata['T_Age_GroupEnd']!=""){ echo " - " .$tampildata['T_Age_GroupEnd'];} ?></td>
			  <td width="200" align="left">Social Economic Class </td>
			  <td width="200" align="left"><span style="text-align:left;padding:0px 0px 3px 3px;"><?php echo $tampildata['T_Sosial_Economic_Class'];?></span></td>
            </tr>
            <tr style='font-size:14px;'>
              <td style="text-align:right; height:20px; padding:0px 2px 0px 0px;">Proposed
              Concept</td>
              <td colspan="6" style="text-align:left;padding:3px 3px 3px 3px;"><div class="b"><?php  echo FormatText($tampildata["Proposed_Concept"]); ?></div></td>
            </tr>
            <tr style='font-size:14px;'>
              <td style="text-align:right; height:20px; padding:0px 2px 0px 0px">Request
              for Content, Production Base, Etc.</td>
              <td colspan="6" style="text-align:left;padding:3px 3px 3px 3px;"><div class="b">
			  <?php  echo FormatText($tampildata["Request_for_Content"]).'</div>'; ?></div></td>
            </tr>
            <tr style='font-size:14px;'>
              <td style="text-align:right; height:20px;padding:0px 2px 0px 0px">Request
              for Design, Container, Etc.</td>
              <td colspan="6" style="text-align:left;padding:3px 3px 3px 3px;"><div class="b"><?php  echo FormatText($tampildata["Request_for_Design"]); ?></div></td>
            </tr>
            <tr style='font-size:14px;'>
			  ...
			  <table cellpadding="0" cellspacing="0" border="1" width="99%" >
                      <tr style='font-size:14px;' bgcolor="#999999">
                        <td width="3%" style="text-align:center; height:40px; adding:2px 2px 2px 2px;">No</td>
                        <td width="10%" style="text-align:center;  padding:2px 2px 2px 2px;">MCJ Item No.</td>
                        <td width="20%" style="text-align:center; padding:2px 2px 2px 2px;">New Product</td>
                        <td width="5%" style="text-align:center; padding:2px 2px 2px 2px;">Netto</td>
                        <td width="10%" style="text-align:center; padding:2px 2px 2px 2px;">Price</td>
                        <td width="7%" style="text-align:center; padding:2px 2px 2px 2px;">HPJ</td>
                        <td width="7%" style="text-align:center; padding:2px 2px 2px 2px;">Target COGS</td>
                        <td width="7%" style="text-align:center;  padding:2px 2px 2px 2px;">COGS(%)</td>
                        <td width="7%" style="text-align:center; padding:2px 2px 2px 2px;">Sales (3MTH)(pcs</td>
						<td width="7%" style="text-align:center;  padding:2px 2px 2px 2px;">Sales (1Yr,pcs)</td>
                      </tr>
					  <?php
					$exe = mysqli_query($con,"SELECT ID_No,MCJ_Item_No,New_Product,Isi_Net,Netto,NamaCurrency,Price,HPJ,
					Target_COGS,COGS,Sales_3Mth,Sales_1yr,Index_No 
				  ...
				  <tr style="font-size:14px; text-align:left; height:30px; padding:2px 2px 2px 2px;">
					...
					<?php echo $rowNPRFDetail['NamaCurrency']." ". formatMoney($rowNPRFDetail['Price'], 1);  ?></td>
					<td style="padding:2px 2px 2px 2px;text-align:right;"><?php echo formatMoney($rowNPRFDetail['HPJ'], 1); ?></td>
					<td style="padding:2px 2px 2px 2px;text-align:right;"><?php echo formatMoney($rowNPRFDetail['Target_COGS'], 1); ?></td>
					<td style="padding:2px 2px 2px 2px;text-align:right;"><?php echo formatMoney($rowNPRFDetail['COGS'], 1);?> %</td>
					<td style="padding:2px 2px 2px 2px;text-align:right;"><?php echo formatMoney($rowNPRFDetail['Sales_3Mth'],1); ?></td>
					<td style="padding:2px 2px 2px 2px;text-align:right;">
					<?php echo formatMoney($rowNPRFDetail['Sales_1yr'], 1)?></td>
				  </tr>
				  <?php $no++;} ?>
                    </table>
				<?php }  ?>
            ...
            <tr style='font-size:14px;'>
              <td style="text-align:right; height:20px;padding:0px 2px 0px 0px">Distribution</td>
              <td colspan="6" style="text-align:left;padding:3px 3px 3px 3px;"><?php  echo $tampildata['Distribution']; ?></td>
            </tr>
            <tr style='font-size:14px;'>
              <td style="text-align:right;height:20px;padding:0px 2px 0px 0px">Competitor</td>
              <td colspan="6" style="text-align:left;padding:3px 3px 3px 3px;">
			  <?php if (cekdata1("tb_nprf_competitor","Request_No",$tampildata['Request_No'])!=0){  ?>
			  <table cellpadding="0" cellspacing="0" border="1" width="99%" >
                      <tr style='font-size:14px;' bgcolor="#999999">
				  ...
				  <tr style="font-size:14px; text-align:left; height:30px; padding:2px 2px 2px 2px;">
					...
					<?php echo $rowNPRFCompetitor['NamaCurrency']." ". formatMoney($rowNPRFCompetitor['Price'], 1);  ?></td>

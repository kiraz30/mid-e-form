...
<link href="../vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <div class="container-fluid"> 
 	...
 	<div class="card mb-4">
		...
		a.MPR_Code,a.Project_Name,a.Subject,a.`Type`,a.Content,a.Remark,a.Type_Finish_Goods,a.Type_Fu_Fee,
		...
		if ($button=="prod-rm-add") {$query.=" And a.Status_Last_Document='1'";}
		else {$query =$query; }
	...
	if($_POST){
		...
		if ($Save=="Revise"){
			...
			SaveTracking($inputAutoRequestNo,'5',"Request pengajuan dibatalkan",$username,$createddate,$hostname); 
			UpdateStatusTracking($inputAutoRequestNo,'0');
		...
		?>
          <table width="100%" border="0" class="table table-striped" id="dataTables-example" >
			...
			<tr>
              <td>Type *</td>
			  <td colspan="2">
				<label><input type="checkbox" name="ChkType1" id="ChkType1" onclick="return false;"
				<?php if (@$tampildata['Type_Finish_Goods']=="1") { echo 'checked="checked"';} ?>> Finish Goods</label>
			  </td>
			</tr>
			<tr>

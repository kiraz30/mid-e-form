...
<table width="100%" border="0" class="table table-striped" id="table table-striped" >
    <tr>
        <td width="20%"><span class="form-group">Code Vendor / Customer * 
		</span></td>
        <td width="30%"><span class="form-group">
			...
			maxlength="50" type="text" placeholder="Input Code Vendor / Customer"  
		  	value="<?php  echo @$tampildata['Code'];?>" <?php echo $required; ?> <?php echo $disabled; ?> />
            </span>  
		</td>
	...
	<tr>
		...
		<td><span class="form-group">Divisi/Department</span></td>
        <td><span class="form-group">
		<input class="form-control py-4"
	...
	<tr>
        ...
        <td><span class="form-group">
			...
			maxlength="200" placeholder="Input Remark" <?php echo $disabled; ?>><?php echo @$tampildata['Remark']; ?></textarea>
            </span>
		</td>
		<td><span class="form-group">PO/FPK Dll</span></td>
        <td><span class="form-group">
    	    <textarea class="form-control"  name="inputDescr" id="inputDescr" 
			maxlength="200" placeholder="Input PO/FPK Dll"  <?php echo $disabled; ?>><?php echo @$tampildata['DESCR']; ?></textarea>
            </span>
...
<script type="text/javascript">
 ...
 function myFunction() {
	if(document.getElementById('inputVendorCustomer').value==""){
		alert("Vendor/Customer Code Can not be empty *");
		document.getElementById('inputVendorCustomer').focus();
        return false;  }
	else if(document.getElementById('inputNamaVendorCustomer').value==""){

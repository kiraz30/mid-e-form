...
$queryARM = "SELECT Request_No FROM tb_format_req_no WHERE WorkFlowMenu='ARM-F1'";
...
$query = "SELECT IfNULL(Max(ID_No)+1,1) as MaxID FROM tb_prod_add_resource WHERE month(CreatedDate)='$bulan' And  Year(CreatedDate)='$tahun'";

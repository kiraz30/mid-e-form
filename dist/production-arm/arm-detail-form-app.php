<?php 
	...
	if (@$tampildata['LAST_TRACK']<>"7" )
		  {$disabledProd="disabled";} else{$disabledProd="";}
	if (@$_POST['getDetail']<>"")
...
<table width="100%" border="0" class="table table-striped" id="table table-striped" >
	...
	<tr>
		...
		<td ><span class="form-group">
			<input class="form-control py-4" <?php  echo $disabled;	?>  
	...
	<tr>
		...
		<div class="form-group d-flex align-items-center justify-content-between mt-0 mb-1">
			...
			maxlength="50" type="text" placeholder="Input Resource Code"  
		  	value="<?php echo @$tampildata['Resource_Code'];  ?>" <?php echo $disabledProd; ?> />
			  <input name="inputPMName" id="inputPMName" type="hidden"  
		  	value="<?php echo @$tampildata['production_Material_Name']; ?>" readonly="readonly" />		
			&nbsp;<button type="button" style="padding:2px 4px 4px 4px"  <?php echo $disabledProd; ?>  
	...
	<tr>
		...
		<input class="form-control py-4"
			...
			maxlength="50" type="text" placeholder="Input SAP Code"  
		  	value="<?php echo @$tampildata['SAP_Code'];  ?>"<?php echo $disabledProd; ?> 
			/>
            </span>
		</td>
	...
	<tr>
        ...
        <td><span class="form-group">
			...
			maxlength="50" type="text" placeholder="Input Std UP" onKeyUp="return angka(this);" 
		  	value="<?php echo @$tampildata['Std_UP']; ?>" <?php echo $disabled; ?>    />
            </span>
		</td>
	...
	<tr>
		...
		onclick="myFunction(); myFunctionPurchase();myFunctionProd();" <?php echo $disabledProd; ?> >Save</button>
	</td>
    </tr>
</table>
</form>

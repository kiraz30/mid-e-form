    ...
    <tr>
        ...
        <td colspan="2">
			<div class="form-group d-flex align-items-center justify-content-between mt-0 mb-1">
				...
				name="btnsearch"
				onClick="popupwindow('production-arm/finish-good-popup.php?id=armf1','Search Finish Good','600','900');"
				 <?php echo $disabled; ?>>
	...
	<tr>
        ...
        <td colspan="2">
			<div class="form-group d-flex align-items-center justify-content-between mt-0 mb-1"> 
				...
				&nbsp;<button type="button" style="padding:2px 4px 4px 4px" class="btn btn-primary" title="Search Search Material"  
				name="btnsearch"
				onClick="popupwindow('packaging-arm-f2/pm-popup.php?id=armf1','Search Material','600','900');"
				 <?php echo $disabled; ?>>
				<span class="glyphicon glyphicon-search" ></span></button>
...
function get_save_form(){
  ...
  var inputRemark			= $('#inputRemark').val();
   $.ajax({
   type: 'POST',
   url: "production-arm/arm-detail-form-save-new.php?type=finish-goods",

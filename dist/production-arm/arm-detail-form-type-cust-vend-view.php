		...
		?>
			...
			<table width="100%" class="table table-striped table-bordered table-hover" 
				...
				<tfoot>
					<tr>
					<th>No</th> 
					<th>Code Vendor/Customers</th> 
					<th>Nama Vendor/Customers  </th> 
					<th>NPWP  </th> 
					<th>Alamat  </th>
					<th>Action</th>
					</tr>
				...
				<tbody>
				<?php
				$query="SELECT ID_No,Request_No,CODE,NAME,NPWP,Alamat
				FROM tb_prod_add_resource_detail_c_v Where Request_No ='$armid' ";
  ...
  if(confirm("Are you sure you want to remove this?"+id))
	{
		$.ajax({
		type: "POST",
		url: "../config/delete-exe.php?pg=del-prod-arm-detail_c_v&id="+id,
		data:{id: id},

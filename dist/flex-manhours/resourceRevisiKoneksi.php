...
input[type=text]:focus {
 ...
 <?php
			...
			Discontinue,DiscontinueDate,cast(LaunchingDate as varchar(10)) LaunchingDate from Master_Item Where Discontinue=0 ";
			if ($SearchCode<>""){
			...
			$exe = sqlsrv_query ($myConn,$query. " Order By Item_Code Asc " );
			$no = 1;

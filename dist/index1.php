...
//include "../config/connect_sqlRevisiKoneksi.php";
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
								...
								<div class="collapse" id="collmasterdata" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
									<nav class="sb-sidenav-menu-nested nav">
									 ...
									 <i class="fas fa-angle-down"></i></div></a>'); ?><!--/ Setting-->
										...
										<!--Format Request No-->
										<?php showprivilage($username,'market-situation','<a class="nav-link" href="index.php?button=market-situation">Templet Market situation</a>'); ?>
										<!--Templet Master Sent To-->
										<?php showprivilage($username,'market-situation','<a class="nav-link" href="index.php?button=sent-to">Master Sent To</a>'); ?>
										<!--Templet Master Address To-->
										<?php showprivilage($username,'market-situation','<a class="nav-link" href="index.php?button=address-to">Master Address To</a>'); ?>
										<!--Templet Market situation-->
                            ...
                            <div class="collapse" id="collpackaging" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									<?php showprivilage($username,'packaging-arm','<a class="nav-link" href="index.php?button=packaging-arm">Additional Resource Master</a>'); ?>
									<?php showprivilage($username,'packaging-spesification','<a class="nav-link" href="index.php?button=packaging-spesification">Packaging Spesification</a>'); ?>
								</nav>
                            </div>						
							...
							aria-expanded="false" aria-controls="collapseLayouts"><div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>Report List
							<div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div></a>'); ?>
                           ...
                           <a class="nav-link collapsed" href="index.php?button=help">
							<div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>Help</a>
	...
	if(isset($_GET['button'])){
		...
		switch ($page) {
			...
			case 'market-situation':
				include "market-situation/market-situation.php";
				break;
			case 'add-market-situation' ; case 'edit-market-situation' :
				include "market-situation/market-situation-add.php";
				break;
			...
			case 'spec-product':
				...
				break;
			case 'add-spec-product';  case 'edit-spec-product' :
				include "spec-product/spec-product-detail.php";
				break;
			...
			case 'packaging-arm':
				include "packaging-arm/packaging-arm.php";
				break;
			case 'packaging-arm-add': case 'packaging-arm-edit' ;
					include "packaging-arm/packaging-arm-add.php";
					break;
			case 'packaging-arm-detail-add';
					include "packaging-arm/packaging-arm-detail-add.php";
					break;
			case 'resource':

   		...
   		<div class="card-body"> 
			...
			<table width="100%" border="0" >
				...
				<tr>
					...
					<td colspan="2"><span class="form-group">
						<select class="form-control" id="SelectMarket" name="SelectMarket"  >
 ...
 $(document).ready(function(){  
      $('#Export').click(function(){  
          ...
          var d = $('#SelectMarket').val();
           ...
           var page = "../config/export-excel.php?pg=spec-product-report&productname=" + a + "&bisnis=" + b + "&status=" + c + "&market=" + d;  

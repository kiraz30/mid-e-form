...
ON  a.WorkFlowProcess =b.UserDomain AND a.WorkFlowMenu=b.WorkFlowMenu AND a.WorkFlowMenu='ARM' AND a.UserDomain='$username' ORDER BY a.ID_No ,b.Index_No");
$indexno=1;
while($caridata =mysqli_fetch_array(@$cari)){
	...
	values ('$NomorReq','$caridata[WorkFlowMenu]','Step $caridata[Index_No]','$caridata[NameApproval]',

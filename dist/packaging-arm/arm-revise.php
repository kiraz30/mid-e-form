...
<html lang="en">
	...
	if($_POST){
		...
		?>
		  ...
		  || @$tampildata['Status_add_resource']=="Revise" || $button=="add-revise-arm"){ ?>
		  ...
		  <?php if (@$tampildata['Status_add_resource']!="Complete" || (@$tampildata['Status_add_resource']=="Complete"  & $button=="add-revise-arm") )  

...
<link href="../vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	...
	if($_POST){
		...
		elseif($Send=="Send"){ 
			mysqli_query($con,"UPDATE tb_packdev_add_resource SET Status_add_resource='Sent',
			...
			if (mysqli_num_rows($exeCariInbox) !=0 ) {
				...
				'".$tampildataNext['OnBehalf']."','0','".$tampildata['Remark']."','ARM')");
			}
...
<script type="text/javascript">
   $(document).ready(function(){
	   $('#add').on('show.bs.modal', function (e) {
		   ...
		   $.ajax({
			   type :'post',
			   url: "packaging-arm/arm-detail-form-edit.php",
 ...
 <script type="text/javascript">
   ...
   $(document).ready(function(){
	   $('#show').on('show.bs.modal', function (e) {
		   ...
		   $.ajax({
			   type :'post',
			   url: "packaging-arm/arm-detail-form.php",

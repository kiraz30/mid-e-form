...
<html lang="en">
    ...
    <div class="container-fluid"> 
      ...
      <div class="card mb-4">
   		<div class="card-header"><a class="btn btn-primary" href="../dist/index.php?button=arm-add">New Additional Resource Master</a></div>
        <div class="card-body"> 
          ...
          <?php
		  	if ($level=="ADMINISTRATOR"){
				...
				Status_add_resource,Remark FROM tb_packdev_add_resource Order By CreatedDate Desc";}
			else{
				$query="SELECT ID_No,Request_No,MPR_Code,Last_Request_No,Status_Last_Document,Project_Name,CreatedBy,date(CreatedDate) as CreatedDate,
				Status_add_resource,Remark FROM tb_packdev_add_resource  
			...
			?>
			  <tr> 
				...
				echo '<a href="../dist/index.php?button=revise-arm&id='.$row['Request_No'].'">';
				}else{
				echo '<a href="../dist/index.php?button=arm-edit&id='.$row['Request_No'].'">';
				}?>
				<span class="fa fa-edit" title="Edit ARM"></span></a></button>	
								
				<button style="padding:2px 4px 2px 2px;margin:1px 1px 1px 1px;" class="btn btn-outline btn-default">
				<a href="#"><span onClick="popupwindow('../dist/page.php?form=workflow&id=<?php echo $row['Request_No'];?>&pg=arm','arm','400','1000');" 
				class="fa fa-user" title="Preview Work Flow" ></span></a></button>	
				
				<button style="padding:2px 4px 2px 2px;margin:1px 1px 1px 1px;" class="btn btn-outline btn-default">
				<a href="#"><span onClick="popupwindow('../dist/page.php?form=privew-arm&id=<?php echo $row['Request_No'];?>','Preview Report','1000','1000',left= '1000',top= '1000',screenX= '1000',screenY= '1000');"
				class="fa fa-file" title="Preview Report"></span> </a>  </button>
				
				<?php if ($row['Status_add_resource']=="Complete"){ ?>
				<button style="padding:2px 4px 2px 2px ;margin:1px 1px 1px 1px;" class="btn btn-outline btn-default">
					<a href="../dist/index.php?button=add-copy-arm&id=<?php echo $row['Request_No'];?>">

		...
		$armid 						= @$_POST['data2'];
		$exe =mysqli_query($con,"SELECT ID_No,Request_No,Status_add_resource FROM tb_packdev_add_resource_f2  where Request_No = '".@$armid."' ");
		...
		?>
			...
			Material_Name_Request FROM tb_packdev_add_resource_f2_detail Where Request_No ='$armid' ";
  ...
  if(confirm("Are you sure you want to remove this?"+id))
	{
		$.ajax({
		type: "POST",
		url: "../config/delete-exe.php?pg=del-arm2-detail&id="+id,
		data:{id: id},

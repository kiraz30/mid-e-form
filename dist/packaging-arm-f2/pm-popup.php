...
<html lang="en">
	...
	function changeparent(doc1,doc2){
        var input1=doc1;
		var input2=doc2;
		window.opener.document.getElementById('inputMaterialCode').value=input1;
		window.opener.document.getElementById('inputMaterialName').value=input2;
	    window.opener.close();
    }
</script>
	...
	<main> 
    <div class="container-fluid"><h3 class="mt-4">Search Material</h3>
	...
	&nbsp; <button type="submit" style="padding:4px 4px 4px 4px;text-transform:uppercase"
         ...
         <div class="card-body"> 
		  ...
		  <table width="100%" class="table table-striped table-bordered table-hover" id=" " >
			  ...
			  <?php
			  	$query = "select top 100  I_ITEM_CD,I_FULL_NAME from MD_PROD_ResourceMaster

...
<script type="text/javascript">
		function addRow(tableID) {
			...
			selectListDomainONBehalf.setAttribute('title',"Select ONBehalf");
    ...
    <div class="container-fluid"> 
      <h3 class="mt-4"><?php if ($button=="add-work-flow") {echo "Add Workflow";} else  {echo "Edit Workflow";} ?> </h3>
	    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="../dist/index.php?button=dashboard">Dashboard</a></li>
		<li class="breadcrumb-item"><a href="../dist/index.php?button=work-flow">Workflow</a></li>
        <li class="breadcrumb-item active"><?php if ($button=="add-work-flow") {echo "Add Workflow";} else  {echo "EditWorkflow";} ?> </li>
      </ol>
 	<div class="card mb-4">
		...
		elseif($button=="edit-work-flow"){ 
			...
			UpdatedHostName='$ip : $hostname' WHERE ID_No='".@$_GET['id']."'");
			//SIMPAN WORK FLOW APPROVAL
        ...
        <div class="form-row"> 
          ...
          <div class="col-md-4"> 
            <div class="form-group"> 
              ...
              <select class="form-control" id="SelectRequestor" name="SelectRequestor" onChange="changeValue(this.value)">
                ...
                <?php
						$div = mysqli_query($con,"SELECT UserDomain FROM tb_user Where UserDomain<>'-' Order By UserDomain Asc");
          ...
          <div class="col-md-4"> 
            <div class="form-group"> 
              <label class="small mb-1" for="inputLastName">Workflow Menu *</label>
		...
		<table id="dataTable" border="1" class="table table-striped table-bordered table-hover">
				...
				<tr> 
					...
					<td><input class="form-control py-4" id="IndexNo[]" name="IndexNo[]" type="text"
				  	  value="<?php echo $rowWFA['Index_No'];?>"  > </td>
				 </tr>
				 <?php $no++;} ?>
            </table>

...
<html lang="en">
	...
	function changeparent(doc0,doc1,doc11,doc2,doc22,doc3,doc4,doc5,doc6,doc7,doc8){
		var input0=doc0;
        var input1=doc1;
		var input11=doc11;
        var input2=doc2;
		...
		var input7=doc7;
		var input8=doc8;
		window.opener.document.getElementById('InputFAWCode').value=input0;
	    ...
	    window.opener.close();
		window.opener.document.getElementById('InputTempFNIMCode').focus();
    }
</script>
			...
			?>
			  ...
			  <tr> 
		 	  ...
		 	  <tr id="extra_<?php echo $row['Request_No'];?>" style="display: none;">
				...
				onClick="javascript:changeparent('<?php echo $rowDetail['FAW_Code']; ?>','<?php echo $row['Request_No']; ?>','<?php echo $row['Request_No']; ?>','<?php echo $rowDetail['ID_No']; ?>','<?php  if ($rowDetail['Code_Product']=='') {echo "XXXXXX";} else {echo $rowDetail['Code_Product'];}?>','<?php echo $rowDetail['Product_Name'];?>','<?php echo substr($isinetto,0,-2); ?>','<?php echo $rowDetail['Type_Request'];?>','<?php echo $rowDetail['ID_No_FNIM_Country'];?>','<?php echo $rowDetail['Country'];?>','<?php echo $rowDetail['Status_Product'];?>');javascript:window.close();">

...
<html lang="en">
    ...
    <div class="container-fluid"> 
      <h3 class="mt-4"><?php if ($button=="ps-add" || $button=="add-revise-ps") 
		{echo "New Request Packaging Spesification";} else  {echo "Edit Packaging Spesification";} ?> </h3>
	    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="../dist/index.php?button=dashboard">Dashboard</a></li>
		<li class="breadcrumb-item"><a href="../dist/index.php?button=arm">Packaging Spesification</a></li>
        <li class="breadcrumb-item active"><?php if ($button=="arm-add" || $button=="add-revise-ps") 
		{echo "New Request APackaging Spesification";} else  {echo "Edit Request Packaging Spesification";} ?> </li>
      </ol>
 	<div class="card mb-4">
		...
		?>
          <table width="100%" border="0" class="table table-striped" id="dataTables-example" >
            <tr>
			  ...
			  value="<?php if ($button=="arm-add") {echo $NomorReq;} elseif ($button=="add-revise-ps") 
            ...
            <tr>
			  ...
			  value="<?php if (@$tampildata['Status_add_resource']=="Complete" & $button=="add-revise-ps") 
            ...
            <tr>
              ...
              <td width="30%"><div class="form-group d-flex align-items-center justify-content-between mt-0 mb-1">
			   ...
			   class="btn btn-primary" title="Search Project Name"  
					name="btnsearch" 
					onClick="popupwindow('packaging-ps/project-name-popup.php?id=mpr','Search Project Name','600','900');" <?php echo $disabled; ?>>
		  ...
		  || @$tampildata['Status_add_resource']=="Revise" || $button=="add-revise-ps"){ ?>
		  ...
		  <button type="submit" name="Save" value="<?php if ($button=="arm-add" || $button=="arm-revise") 
		  {echo"Save";} else {echo"Update";}  ?>"
		  <?php if ($button=="arm-add" || $button=="arm-revise") 
		   {echo 'onclick="return checkDraft(arm)"';} else {echo 'onclick="return checkEdit(arm)"';} ?>  
		  class="btn btn-primary"
		  <?php if (@$tampildata['Status_add_resource']!="Complete" || (@$tampildata['Status_add_resource']=="Complete"  & $button=="add-revise-ps") )  
		  {echo $disabled;} else {echo "disabled='disabled'";} ?>>Draft</button>
		  <?php ;} ?>
		  
		  <?php if (@$tampildata['Status_add_resource']=="Complete" & $button!="add-revise-ps")  {?>
		  <button type="submit" name="Save" value="Revise" onClick="return checkRevise()" 
		  class="btn btn-primary">Revise</button>
	      <?php ;} ?>
		  <?php if (@$tampildata['Status_add_resource']=="Complete" & $button!="add-revise-ps" || @$tampildata['Status_add_resource']=="Revise" & $button!="add-revise-ps")  {?>
...
$(document).ready(function(){
 ...
 function get_ArmDetail(){
  ...
  $.ajax({
   type: 'POST',
   url: "packaging-ps/arm-detail-add.php",

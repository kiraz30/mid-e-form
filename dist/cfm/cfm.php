...
<html lang="en">
    ...
    <div class="container-fluid"> 
      <h3 class="mt-4">Checklist Final Manuscript (CFM)</h3>
	    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="../dist/index.php?button=dashboard">Dashboard</a></li>
        <li class="breadcrumb-item active">Checklist Final Manuscript (CFM)</li>
      </ol>
      <div class="card mb-4">
   		<div class="card-header"><a class="btn btn-primary" href="../dist/index.php?button=add-cfm">New Request CFM</a></div>
        <div class="card-body"> 
		  ...
		  <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
              <thead>
                <tr bgcolor="#999999">
				  <th width="1%">No</th> 
				  <th width="11%">Request No</th> 
				  <th width="8%">Request Date</th>
                  <th width="11%"> FNIM Request No</th>
				  <th width="8%">No Urut Product</th>
				  <th>Product Name</th>
				  <th width="10%">Created By</th>
				  <th height="5%">Status</th>
              ...
              <tbody>
          <?php
		  $query="SELECT a.ID_No,a.Request_No,a.Last_Request_No,a.Status_Last_Document,a.FNIM_Code,
				a.ID_No_FNIMDetail, e.Code_Product,c.Product_Name,
				a.CreatedBy,date(a.CreatedDate) as Created_Date,a.Status_CFM FROM tb_cfm a 
			...
			$exe = mysqli_query($con,$query." GROUP BY a.ID_No,a.Request_No,a.Last_Request_No,a.Status_Last_Document,a.FNIM_Code,
				a.ID_No_FNIMDetail, e.Code_Product,c.Product_Name,
				a.CreatedBy,Created_Date,a.Status_CFM Order By a.CreatedDate DESC");
			$no = 1;
			...
			?>
			  <tr> 
				...
				<td><?php echo $row['Status_CFM'];?></td>

				<td align="center"><button style="padding:0px 0px 0px 0px">
		 
		 <?php if ($row['Status_CFM']=="Revise"){
				echo '<a href="../dist/index.php?button=revise-cfm&id='.$row['Request_No'].'">';
				}else{
				echo '<a href="../dist/index.php?button=edit-cfm&id='.$row['Request_No'].'">';
				}?>
				<span class="fa fa-edit" title="Edit CFM"></span></a></button>	
				...
				<button style="padding:0px 0px 0px 0px">
				<a href="#">
				<span onClick="popupwindow('../dist/page.php?form=privew-cfm&id=<?php echo $row['Request_No'];?>','CFM','700','1000');"
				class="fa fa-file" title="Preview Report"></span> </a> </button>
				
				<?php if ($row['Status_CFM']=="Complete" & $row['Status_Last_Document']=="1"){ ?>
				 	<button style="padding:0px 0px 0px 0px">
					<a href="../dist/index.php?button=add-revise-cfm&id=<?php echo $row['Request_No'];?>">
					<span class="glyphicon glyphicon-duplicate" title="Revise CFM"></span></a></button>	
				 
				<?php }?>
				 <button style="padding:0px 0px 0px 0px"  onClick="return checkDelete();">
				 <a href="../config/delete-exe.php?pg=del-cfm&id=<?php echo $row['Request_No'];?>">
